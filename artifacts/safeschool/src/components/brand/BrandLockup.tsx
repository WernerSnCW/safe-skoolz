...
// End users see "{School} vibez" (the per-tenant skin). The platform endorsement
// "vibez — software for VBE" appears only where `endorse` is requested
...
export function BrandLockup({
  ...
  const name = tenant?.displayName ? `${tenant.displayName} vibez` : "vibez";
