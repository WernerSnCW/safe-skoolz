...
- **Phase 2 — Teach-then-ask front door + "Learn" area + complete-solution story.** The value-led landing as a platform template; fold the marketing site's VBE-education content in as Learn; surface the four-stakeholder complete-solution view; begin retiring the separate marketing surfaces.
